        ...
        if 'action' in request.GET:
                    ...
                    if tipo == 1:
                        ...
                        for i in cab:
                            ...
                            for gestion in gestiones:
                                ...
                                gestionproact = GestionProductoServicioTH.objects.filter( gestion__cabecera__periodo=du_periodo,status=True)
            ...
            #Reportes
                ...
                try:
                    ...
                    gestion = GestionProductoServicioTH.objects.get(id=encrypt(request.GET['id'])).gestion.gestion
                    data['idp']=encrypt(producto.gestion.cabecera.pk)
                    form.cambiar(gestion.pk)
                    data['form'] = form
                    template = get_template("ajaxformmodal.html")
                    return JsonResponse({"result": True, 'data': template.render(data)})

        ...
        if 'action' in request.GET:
            ...
            try:
                ...
                if 'exportar_excel' in request.GET:
                    ...
                    columns = [u"N°", u"CEDULA", u"ESTUDIANTE", u"CORREO",
                    ...
                    for list in inscritos:
                        ...
                        ws.cell(row=row_num, column=3, value=str(list.inscripcion.persona.nombre_completo_minus()))
                        ...
                        ws.cell(row=row_num, column=5, value=str(list.inscripcion.coordinacion.nombre))
                        ws.cell(row=row_num, column=6, value=str(list.inscripcion.carrera.nombre))
                        ws.cell(row=row_num, column=7, value=str(list.grupo.periodo.descripcion))
                        ws.cell(row=row_num, column=8, value=str(list.grupo.nombre))
                        ws.cell(row=row_num, column=9, value=str(list.grupo.id))
                        ws.cell(row=row_num, column=10, value=str(list.grupo.fecinicio))
                        ws.cell(row=row_num, column=11, value=str(list.grupo.horainicio)  + ' - ' +  str(list.grupo.horafin))
                        if list.estado == 0:
                            estado = 'En curso'
                        elif list.estado == 1:
                            estado = 'Aprobado'
                            ...
                            estado = 'Reprobado'
                        ws.cell(row=row_num, column=12, value=str(estado))
                        ws.cell(row=row_num, column=13, value=str(list.grupo.idcursomoodle))
                        ws.cell(row=row_num, column=14, value=str(list.nota))
                        ws.cell(row=row_num, column=15, value=str(list.observacion))
                        row_num += 1
                        numero += 1
                    wb.save(response)
                    return response

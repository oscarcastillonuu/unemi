...
class Requisito(ModeloBase):
    ...
    archivoformato = models.FileField(upload_to='requisitobecadocente/%Y/%m/%d', blank=True, null=True, verbose_name=u'Archivo del formato')
...
class Convocatoria(ModeloBase):
    ...
    def __str__(self):
        return u'%s - %s - %s - %s' % (self.descripcion, self.iniciopos, self.finpos, self.estado.descripcion)

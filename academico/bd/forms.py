...
from bd.models import PeriodoGrupo, TIPO_PERIODO_CRONTAB_CHOICES, PeriodoCrontab, APP_LABEL_TEMPLATE, CategoriaIndice, \
    ...
    ProcesoOpcionSistema, TipoOpcionSistema, EquipoSCRUM, TIPO_EJECUTOR, PythonProcess
...
class ReportesForm(forms.Form):
    ...
    vista = forms.CharField(label=u'Vista', max_length=500, help_text=u"", required=False, widget=forms.Textarea({'rows': '6', 'class': 'form-control', 'col': '12', 'placeholder':'Describa la descripción...'}))
    html = forms.CharField(label=u'Html', max_length=500, help_text=u"", required=False, widget=forms.Textarea({'rows': '6', 'class': 'form-control', 'col': '12', 'placeholder':'Describa la descripción...'}))
...
class IncidenciaSCRUMForm(FormModeloBase):
    ...
    titulo = forms.CharField(label=u'Título', max_length=100, required=True, widget=forms.TextInput({'col': '12', 'placeholder': 'Describa un título a su tarea'}))

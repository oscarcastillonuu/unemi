        ...
        if action == 'matrizanalisisperiodoacademico':
            ...
            try:
                if 'id' in request.POST:
                    ...
                    periodos = Periodo.objects.filter(status=True, id__in=idperiodos).exclude(nombre__icontains='TITU').order_by('-id')
...
"""
                ...
                try:
                    ...
                    ws.merge_range('A1:R1', 'Reporte general de matriculados', formatotitulo_filtros)

...
from sga.funciones import generar_codigo, log, generar_nombre, notificacion3, variable_valor
from sga.models import PerfilUsuario, Notificacion, Matricula, AsignaturaMalla, Reporte

                    ...
                    try:
                        ...
                        if 'id' in request.query_params:
                            ...
                            encuesta = EncuestaGrupoEstudianteSeguimientoSilabo.objects.values_list('fechainicioencuesta',
                                ...
                                encuestagrupoestudiantes_id__in=idInscripcion, status= True)
    ...
    def post(self, request):
        ...
        with transaction.atomic():
            try:
                ...
                log(u'Respondio encuesta: %s - %s' % (eEncuestaGrupoEstudiantes, eInscripcionEncuestaEstudianteSeguimientoSilabo), request, "edit")

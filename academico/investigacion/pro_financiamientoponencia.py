        ...
        if action == 'addsolicitud':
            try:
                ...
                if form.is_valid():
                    ...
                    if relativedelta.relativedelta(form.cleaned_data['fechainicio'], datetime.now().date()).months < 3:
                        return JsonResponse({"result": "bad", "titulo": "Atención!!!", "mensaje": u"La fecha de inicio debe ser mayor o igual a 3 meses en relación a la fecha actual", "showSwal": "True", "swalType": "warning"})
                    ...
                    if form.cleaned_data['fechainicio'] > form.cleaned_data['fechalimpago']:
                        return JsonResponse({"result": "bad", "titulo": "Atención!!!", "mensaje": u"La fecha de límite de pago de inscripción debe ser mayor o igual a la fecha de inicio", "showSwal": "True", "swalType": "warning"})
            ...
            try:
                ...
                lista_email_envio = ['investigacion@unemi.edu.ec', 'fespinelo@unemi.edu.ec']

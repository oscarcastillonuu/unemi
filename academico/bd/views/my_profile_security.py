        ...
        if 'action' in request.GET:
            ...
            if action == 'two_step_verification':
                try:
                    ...
                    return render(request, "my_profile/security/two_step_verification.html", data)
                except Exception as ex:
            ...
            try:
                data['title'] = 'Gestionar privacidad de mi cuenta'

                return render(request, "my_profile/security/view.html", data)
            except Exception as ex:

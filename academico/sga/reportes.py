                        ...
                        if isQR:
                            ...
                            if (parametros_reporte.extra).upper() == "MATRICULA":
                                ...
                                if matricula.retiradomatricula:
                                    raise NameError(f'El estudiante actualmente no se encuentra retirado de la carrera {matricula.inscripcion.carrera} en el período actual')
                            else:
                        ...
                        if 'variableqr' in request.GET:
                            ...
                            if (parametros_reporte.extra).upper() == "MATRICULA":
                                ...
                                if not matricula.status:
                                    raise NameError('El estudiante actualmente no se encuentra matriculado en el periodo actual')
                                if matricula.retiradomatricula:
                                    raise NameError(f'El estudiante no se encuentra retirado de la carrera {matricula.inscripcion.carrera} en el período actual')
                            else:

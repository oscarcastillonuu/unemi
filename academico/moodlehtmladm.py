...
#for materia in Materia.objects.filter(actualizarhtml=True, status=True, modelotarjeta=True, nivel__periodo_id=110, asignaturamalla__malla__carrera__coordinacion__id__in=[1, 2, 3, 4, 5]):
    #print("%s" % materia)

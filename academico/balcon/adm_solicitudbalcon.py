    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            try:
                ...
                search, responsable, filtro,  filtro2, url_vars, devueltos = request.GET.get('direccion', ''), request.GET.get('agente', ''), \
                                                      ...
                                                      Q(status=True), Q(status=True), '', request.GET.get('devueltos', '')

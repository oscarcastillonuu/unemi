        ...
        if 'action' in request.GET:
            ...
            try:
                ...
                if persona.usuario.is_superuser:
                    ...
                    eAulaPlanificacionSedeVirtualExamen = AulaPlanificacionSedeVirtualExamen.objects.filter(Q(responsable=persona) | Q(turnoplanificacion__fechaplanificacion__supervisor=persona) | Q(supervisor=persona),
                ...
                if 'ida' in request.GET:
                    ...
                    if persona.usuario.is_superuser:
                        ...
                        eMateriaAsignadaPlanificacionSedeVirtualExamenes = MateriaAsignadaPlanificacionSedeVirtualExamen.objects.filter(Q(aulaplanificacion__responsable=persona) |
                                                                                                                                        ...
                                                                                                                                        Q(aulaplanificacion__supervisor=persona),

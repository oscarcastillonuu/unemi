            ...
            try:
                ...
                if modeloNotas > 0:
                    ...
                    sql = """SELECT DISTINCT  ARRAY_TO_STRING(array_agg(us1.id),',')                                      
                            ...
                            AND us1.id in %s""" % (10, instructor.idcursomoodle, listadocodigo)
                    cursor.execute(sql)

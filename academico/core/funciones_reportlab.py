...
def style_table_type(page_width, column_widths, context={}):
    ...
    if type_style == 'hidden':
        ...
        style = TableStyle([('BACKGROUND', (0, 0), (-1, 0), bg),
                            ...
                            ('ALIGN', (0, 0), (-1, -1), 'CENTER'),  # Alineación horizontal en el centro
                            ('VALIGN', (0, 0), (-1, -1), 'MIDDLE'),  # Alineación vertical en el centro
...
def generar_pdf_reportlab_v1(file_name, context, type_return=None):
    pdf_bytesio = BytesIO()
    ...
    for infoBottom in context.get('infoBottom', []):
        ...
        contenido.append(Spacer(1, 12))
    # Crear documento PDF
    doc = SimpleDocTemplate(pdf_bytesio, pagesize=pagesize, encoding='utf-8')

...
from sga.models import Inscripcion, Periodo, TestSilaboSemanal, TestSilaboSemanalAdmision, LinkMateriaExamen, Coordinacion
...
class ResponsableDepartamento(ModeloBase):
    ...
    responsable = models.ForeignKey('sga.Persona', verbose_name=u'Persona que recibe solicitud en dirección',on_delete=models.CASCADE)
...
class EncuestaProceso(ModeloBase):
    ...
    def preguntas_para_estadisticas(self):
        return self.preguntaencuestaproceso_set.filter(status=True)

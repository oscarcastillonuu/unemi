...
from sga.forms import InstitucionEducacionSuperiorForm, InstitucionesColegioForm ,ColegioForm, TipoColegioForm
        ...
        if 'action' in request.GET:
            ...
            if action == 'add':
                ...
                try:
                    ...
                    form = ColegioForm(initial={'nombre': colegio.nombre,'codigo': colegio.codigo,
                ...
                try:
                    data['title'] = u'Eliminar Colegio'
                    data['colegio'] = Colegio.objects.get(pk=request.GET['idcolegio'])
                    return render(request, "institucionescolegio/deletecolegiohojadevida.html", data)
                except Exception as ex:
                    pass

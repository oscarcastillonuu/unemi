<script lang="ts">
	...
	const save = async (formData) => {
		...
		formData.append('action', 'addarchivofinaltitulacion');
		formData.append('id', aData.tema_participante.id);
		formData.append('en_pareja', aData.en_pareja);
...
<form id="FormAddArchivoFinal" on:submit|preventDefault={onSubmit}>
	<div class="row">
		<div class="col-12 mb-4" id="fieldset_archivo">
			<FormGroup>
				<Label class="mb-3" for="id_archivo">Archivo <span class="text-danger">*</span></Label>

...
from sga.models import ProfesorMateria, MateriaAsignada, DetalleSilaboSemanalTema, Profesor, Materia, Matricula, \
    ...
    Coordinacion, Sesion, Malla, Paralelo, Persona, TIEMPO_DURACION, DIAS_CHOICES, TIPO_PRACTICA_PP, ESTADO_PREINSCRIPCIONPPP, \
    ItinerariosMalla, DetallePreInscripcionPracticasPP, AcuerdoCompromiso, Pais, AsignacionEmpresaPractica, EmpresaEmpleadora, \
    PracticasDepartamento, TIPO_INSTITUCION, SECTOR_ECONOMICO, CabPeriodoEvidenciaPPP, TIPOS_IDENTIFICACION, Sexo, ParentescoPersona, \
    CENTRO_CUIDADO, TIPO_INSTITUCION_LABORAL
from sga.forms import ExtFileField
from posgrado.models import Requisito, ClaseRequisito
from inno.models import HorarioTutoriaAcademica, TOPICO_SOLICITUD_TUTORIA, TIPO_SOLICITUD_TUTORIA, \
    ...
    ESTADO_CONSTATACION, TerminosCondiciones, ESTADO_APROBACION
...
class PresidenteCursoForm(FormModeloBase):
    presidente = forms.IntegerField(initial=0, required=False, label=u'Persona',widget=forms.TextInput(attrs={'select2search': True,'class':'form-control','col': '12'}))

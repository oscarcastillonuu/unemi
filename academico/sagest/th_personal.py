...
from settings import PROFESORES_GROUP_ID, EMPLEADORES_GRUPO_ID, ALUMNOS_GROUP_ID, SITE_STORAGE, PUESTO_ACTIVO_ID, MEDIA_ROOT
    ...
    #Información laboral
        ...
        # Acción de personal
            ...
            try:
                ...
                personaaccion = Persona.objects.get(pk=encrypt(request.POST['id']))
        ...
        # Declaración de bienes
            ...
            try:
                ...
                if f.is_valid():
                    ...
                    if DeclaracionBienes.objects.filter(persona=administrativo, fecha=f.cleaned_data['fecha'],status=True).exists():
        ...
        if 'action' in request.GET:
            ...
            # Acción de personal
                ...
                try:
                    ...
                    data['servidor'] = administrativo = Persona.objects.get(id=int(request.GET['ida']))
                    acciones = administrativo.accionpersonal_set.filter(status=True).order_by('-id')
                    acciones2 = administrativo.personaacciones_set.filter(status=True, migrado=False).order_by('-id')

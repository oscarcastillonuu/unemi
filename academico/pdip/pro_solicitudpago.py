...
from .forms import PerfilPuestoDipForm, RequisitoPagoDipForm, ReemplazarDocumentoRequisitoSolicitudForm, \
    SolicitudPagoForm, BitacoraActividadDiariaFixedForm
        ...
        if 'action' in request.GET:
            ...
            if action == 'solicitarpago':
                ...
                try:
                    ...
                    registro = RequisitoSolicitudPago.objects.filter(status=True,solicitud=query)
                    data['lista'] = registro
                ...
                try:
                    ...
                    data['listado'] = actividades = BitacoraActividadDiaria.objects.filter(status=True, observacion__isnull=False, corregida=False, fecha__date__gte=solicitud.fechainicio.date(), fecha__date__lte=solicitud.fechaifin.date())

        ...
        if 'action' in request.GET:
            ...
            try:
                ...
                if periodo.tipo_id != 3 and periodo.clasificacion != 2:
                    if materiasprofesor:
                        materiasprofesor = materiasprofesor.filter(Q(modeloevaluativo_id=27) | Q(asignaturamalla__malla__carrera__modalidad=3) | Q(asignaturamalla__malla__carrera__coordinacion=9)).exclude(pk__in=materiacontutorvirtual)
                ...
                if profesor.autor_puede_ver_seguimentos(periodo):
                    ...
                    pids = ProfesorMateria.objects.filter(materia__nivel__periodo=periodo,profesor__persona__real=True, materia__modeloevaluativo_id=27, materia__asignatura_id__in=asig, activo=True, tipoprofesor_id=16).values_list('profesor_id', flat=True)

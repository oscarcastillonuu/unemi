...
from postulaciondip.forms import RequisitosConvocatoriaInscripcionForm, DatoPersonalForm, ExperienciaLaboralForm, TitulacionPersonaForm, DatosDomicilioForm, DiscapacidadForm, \
    RequisitosInscripcionForm, DatosPersonalesForm, CuentaBancariaPersonaForm
...
def view(request):
    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            if action == 'listsubareaconocimiento':
                try:
            ...
            if action == 'listadoactividadeconomica':
                try:
                    lista = []
            ...
            if action == 'listadopostulaciones':
                try:
                    data['title'] = u'Listado de postulaciones'
            ...
            if action == 'requisitospreaprobados':
                try:

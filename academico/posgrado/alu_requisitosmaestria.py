...
from sga.models import Persona, DescuentoPosgradoMatricula, RequisitosDetalleConfiguracionDescuentoPosgrado, \
    ...
    SubAreaEspecificaConocimientoTitulacion, Reporte, AsignaturaMalla, PeriodoCarreraCosto, PerfilUsuario
from inno.models import InfraestructuraEquipamientoInformacionPac, TipoFormaPagoPac, DetallePerfilIngreso

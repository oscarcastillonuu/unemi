    ...
    if request.method == 'POST':
        ...
        if action == 'periodo_carrera':
            ...
            try:
                ...
                totalproyectado = Decimal(null_to_decimal(Rubro.objects.values_list('valor').filter(filtro
                                                                                                    ).aggregate(
                ...
                retirados = Matricula.objects.filter(retiradomatricula=True,

    ...
    if request.method == 'POST':
        ...
        if action == 'addarticulo':
            try:
                ...
                if f.is_valid():
                    ...
                    solicitudpublicacion = SolicitudPublicacion(
                        ...
                        volumen=f.cleaned_data['volumenrevista'],
                        numero=f.cleaned_data['numerorevista'],
                        paginas=f.cleaned_data['paginaarticulorevista'],
                    ...
                    log(u'%s adicionó solicitud de registro de artículo publicado: %s' % (persona, solicitudpublicacion), request, "add")
            ...
            try:
                ...
                if f.is_valid():
                    ...
                    solicitudpublicacion.volumen = f.cleaned_data['volumenrevista']
                    solicitudpublicacion.numero = f.cleaned_data['numerorevista']
                    solicitudpublicacion.paginas = f.cleaned_data['paginaarticulorevista']
                    ...
                    log(u'%s editó solicitud de registro de artículo publicado: %s' % (persona, solicitudpublicacion), request, "edit")
        ...
        if 'action' in request.GET:
            ...
            if action == 'solicitudespublicacion':
                ...
                try:
                    data['title'] = u'Agregar Solicitud de Registro de Artículo Publicado'
                ...
                try:
                    data['title'] = u'Editar Solicitud de Registro de Artículo Publicado'

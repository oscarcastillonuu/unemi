    ...
    if request.method == 'POST':
        ...
        # PERSONA
            ...
            try:
                ...
                template_asistencia_pdf = "adm_ejecuform/certificadoasistencia_pdf.html"
                ...
                for ins in inscritos:
                    ...
                    if capevento.rubroepunemi:
                        if ins.existerubrocurso() and ins.total_saldo_rubro() == 0:#ins.existerubrocurso() and
                    ...
                    if search:
                        ...
                        filtro = filtro & Q(
                            Q(instructor__nombres__icontains=search) | Q(instructor__apellido1__icontains=search) | Q(
                                instructor__apellido2__icontains=search))
                        data['search'] = search
                    query = CapModeloEvaluativoGeneralFormaEjecutiva.objects.filter(filtro)
                    paging = MiPaginador(query, 20)
                    p = 1
                    try:
                        paginasesion = 1

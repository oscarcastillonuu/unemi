...
from investigacion.forms import GrupoInvestigacionForm, FinanciamientoPonenciaForm, EvaluadorObraRelevanciaForm, ConvocatoriaObraRelevanciaForm, PeriodoEvaluacionInvestigacionForm
...
from investigacion.models import GrupoInvestigacion, FUNCION_INTEGRANTE_GRUPO_INVESTIGACION, GrupoInvestigacionIntegrante, ConvocatoriaObraRelevancia, ObraRelevancia, ObraRelevanciaRecorrido, ObraRelevanciaEvaluador, EvaluacionObraRelevancia, RubricaObraRelevancia, RubricaObraRelevanciaConvocatoria, \
    PeriodoEvaluacionInvestigacion, CriterioEvaluacionInvestigacion
    ...
    if request.method == 'POST':
        ...
        if 'action' in request.GET:
            ...
            if action == 'addperiodo':
                try:
                    data['title'] = u'Agregar Periodo de Evaluación de Investigación'
                    form = PeriodoEvaluacionInvestigacionForm()
                    data['form'] = form
            ...
            try:
                ...
                periodos = PeriodoEvaluacionInvestigacion.objects.filter(filtro).order_by('-inicio', '-fin')
                ...
                data['title'] = u'Periodos Evaluacion Investigación'

...
from investigacion.models import TipoRecursoPresupuesto, IndustriaPriorizada, ZonaPlanificacion, \
    ...
    Periodocidad, Categoria, GrupoInvestigacion, ConvocatoriaObraRelevancia, RubricaObraRelevancia, RubricaObraRelevanciaConvocatoria, ObraRelevanciaEvaluador, GrupoInvestigacionRequisitoIntegrante, CriterioEvaluacionInvestigacion
...
class CategoriaAdmin(ModeloBaseAdmin):
    list_display = ('id', 'descripcion', 'numero', 'vigente',)
    ordering = ('numero',)
    search_fields = ('descripcion', )

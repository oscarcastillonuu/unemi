                    ...
                    try:
                        ...
                        if tipo == ACTA_SUSTENTACION_NOTA:
                            ...
                            if puede:
                                ...
                                eTemaTitulacionPosgradoMatricula.archivo_certificacion_defensa = nfileDocumento
                                integrante.firmo = True
                                integrante.save(request)
                                eTemaTitulacionPosgradoMatricula.save(request)
        ...
        try:
            ...
            if 'action' in request.query_params:
                ...
                try:
                    ...
                    if not ConfiguracionTitulacionPosgrado.objects.filter(periodo=periodo, carrera=inscripcion.carrera,status=True, publicado=True).exists():
                    ...
                    if ConfiguracionTitulacionPosgrado.objects.filter(periodo=periodo, carrera=inscripcion.carrera,status=True,publicado=True).exists():
